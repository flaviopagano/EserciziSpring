...
public class SalaryController {
    ...
    /**
     *  Ho dovuto commentare questo metodo (si può anche commentare l'altro getAll),
     *  perchè Spring ritorna un errore, che i due metodi sono ambigui
     *  - java.lang.IllegalStateException: Ambiguous mapping. Cannot map 'salaryController' method -
     */
